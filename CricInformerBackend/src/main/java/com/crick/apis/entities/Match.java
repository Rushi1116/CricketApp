...
public class Match {
	...
	public void setMatchStatus() {
		this.status = this.textComplete.isBlank() ? MatchStatus.LIVE : MatchStatus.COMPLETED;
	}
	...
	public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore,
		...
		super();
		this.matchId = matchId;							this.teamHeading = teamHeading;
		this.matchNumberVenue = matchNumberVenue;		this.battingTeam = battingTeam;
		this.battingTeamScore = battingTeamScore;		this.bowlTeam = bowlTeam;
		this.liveText = liveText;						this.matchLink = matchLink;
		this.textComplete = textComplete;				this.status = status;
		this.date = date;								this.bowlTeamScore = bowlTeamScore;
	}
